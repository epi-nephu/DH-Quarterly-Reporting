...
output: 
  html_document: 
    ...
    toc_float: true
knit: (function(input, ...) {
  rmarkdown::render(input, output_file = paste0("2026 Q3", " DH Quarterly Reporting", " Completed Notifications"), output_dir = "../Reports") })
---
...
**Percentage of case follow-up marked as completed for allocated cases and their contacts on statewide databases in accordance with quick entry guides and statewide protocols**
...
signed_nephu <- cases_nephu %>%
  ...
  dplyr::filter(lga %in% nephu_lgas) %>% 
  #
