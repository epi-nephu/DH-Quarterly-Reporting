...
:::{.infobox}
**SQ1.6** Number of incidents (Model 1)
...
Data were extracted from PHESS via PHAR for all notifiable conditions (cases) and outbreaks completed by NEPHU between `r format(quarter_start, format = "%d/%m/%Y")` and `r format(quarter_end, format = "%d/%m/%Y")`. 
